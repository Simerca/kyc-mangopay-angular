...
export class FormComponent implements OnInit {
  ...
  constructor(
    ...
    this.kycForm = this.formBuilder.group(
      {
        LegalRepresentativeEmail:['', [Validators.required, Validators.email]],
        ...
        HQAddressLine1:['', Validators.required],
        HQAddressLine2:['', Validators.required],
        HQPostalCode:['', Validators.required],
        HQCity:['', Validators.required],
        HQRegion:['', Validators.required],
  ...
  onSubmit(value){
    if (this.kycForm.invalid) {
      ...
      this.kyc.createLegaleUser(value);
    }
  }
